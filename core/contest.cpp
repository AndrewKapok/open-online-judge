...
{
    j = json{{"inputPath", obj.inputPath},
...
{
    j = json{{"caseNumber", obj.caseNumber}, {"compileArgv", obj.compileArgv}, {"caseList", obj.caseList}};
}
...
{
    j = json{{"disable", obj.disable}, {"startTime", obj.startTime},       {"endTime", obj.endTime},
             {"id", obj.id},           {"problemCount", obj.problemCount}, {"problemList", obj.problemList}};
}
